...
#define RESCAN_GPIO         GPIO_NUM_21 // Handshake line
...
void app_main(void)
{
    ...
    // Rescan handshake GPIO
    gpio_config_t out = {
        .pin_bit_mask = (1ULL << RESCAN_GPIO),
    ...
    ESP_LOGI(TAG, "Ready — forward/back/reset + rescan enabled");
}